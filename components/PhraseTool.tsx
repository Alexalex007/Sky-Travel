...
const ToolboxTool: React.FC = () => {
  return (
    <div className="h-full flex flex-col p-6 pb-24 bg-[#05080F]">
       <div className="flex items-center justify-center mb-8">
           <div className="w-16 h-16 bg-[#1f2937] rounded-3xl grid grid-cols-2 gap-1 p-3 border border-white/5 shadow-lg">
               <div className="border-2 border-slate-500 rounded-lg"></div>
               <div className="border-2 border-slate-500 rounded-lg"></div>
               <div className="border-2 border-slate-500 rounded-lg"></div>
               <div className="border-2 border-slate-500 rounded-lg"></div>
           </div>
       </div>
       <h2 className="text-2xl font-bold text-white text-center mb-8">旅行百寶箱</h2>

       {/* Top Tabs */}
       <div className="bg-[#1f2937] p-1.5 rounded-2xl flex mb-6 border border-white/5">
         <button className="flex-1 py-3 rounded-xl text-sm font-bold flex items-center justify-center gap-2 bg-[#2d3748] text-white shadow-lg border border-white/5">
       ...
       <div className="space-y-4 overflow-y-auto no-scrollbar pb-10">
           ...
           {/* News Card */}
           <div className="glass-card p-4 rounded-[24px] flex items-center justify-between group hover:bg-[#1e293b] transition-colors border border-white/10 cursor-pointer">
               <div className="flex items-center gap-4">
                   ...
                   <div>
                       <h3 className="font-bold text-white">當地新聞</h3>
           ...
           <div className="glass-card p-4 rounded-[24px] flex items-center justify-between group hover:bg-[#1e293b] transition-colors border border-white/10 cursor-pointer">
               <div className="flex items-center gap-4">
                   ...
                   <div>
                       <h3 className="font-bold text-white">Google 翻譯</h3>
           ...
           <div className="glass-card p-4 rounded-[24px] flex items-center justify-between group hover:bg-[#1e293b] transition-colors border border-white/10 cursor-pointer">
               <div className="flex items-center gap-4">
                   ...
                   <div>
                       <h3 className="font-bold text-white">當地天氣</h3>
           ...
           <div className="grid grid-cols-2 gap-4">
              <div className="glass-card p-6 rounded-[24px] border border-white/10 flex flex-col items-center justify-center gap-2 hover:bg-[#1e293b] transition-colors cursor-pointer aspect-[4/3]">
                   <div className="w-10 h-10 bg-orange-500 rounded-xl flex items-center justify-center text-white font-bold text-lg">K</div>
                   <span className="font-bold text-sm text-slate-300">Klook</span>
              </div>
              <div className="glass-card p-6 rounded-[24px] border border-white/10 flex flex-col items-center justify-center gap-2 hover:bg-[#1e293b] transition-colors cursor-pointer aspect-[4/3]">
                   ...
                   <span className="font-bold text-sm text-slate-300">KKday</span>
              </div>
           </div>
       </div>
    </div>
